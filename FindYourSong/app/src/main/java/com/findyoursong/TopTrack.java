...
public class TopTrack extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mvs.add(mv4);
        mvs.add(mv5);
        String phpPath="http://findmysong.web.illinois.edu/top_track.php";
        ...
        btn_album_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String track_name = ((TextView) findViewById( R.id.text1)).getText().toString();
                track_search s=new track_search(TopTrack.this);
        ...
        btn_album_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String track_name = ((TextView) findViewById( R.id.text2)).getText().toString();
                track_search s=new track_search(TopTrack.this);
                s.execute(track_name);
            }
        });
        ...
        btn_album_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String track_name = ((TextView) findViewById( R.id.text3)).getText().toString();
                track_search s=new track_search(TopTrack.this);
                s.execute(track_name);
            }
        });
        ...
        btn_album_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String track_name = ((TextView) findViewById( R.id.text4)).getText().toString();
                track_search s=new track_search(TopTrack.this);
                s.execute(track_name);
            }
        });
        ...
        btn_album_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String track_name = ((TextView) findViewById( R.id.text5)).getText().toString();
                track_search s=new track_search(TopTrack.this);
                s.execute(track_name);
            }
        });
